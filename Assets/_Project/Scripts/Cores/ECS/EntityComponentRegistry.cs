...
namespace Kope.Core.EntityComponentSystem
{
    ...
    /// </summary>
    [Serializable]
    public class EntityComponentRegistry : IReadOnlyEntityRegistry
    {
        /// <summary>
        ...
        private readonly HashSet<Type> excludedTypes = new()
    {
        ...
        public EntityComponentRegistry(Transform entityTransform, bool hasBehavioralComponents, List<string> excludedTypes = null)
        {
        ...
        /// <param name="entityTransform"></param>
        /// <param name="excludedTypes"></param>
        public EntityComponentRegistry(Transform entityTransform, bool hasBehavioralComponents, HashSet<Type> excludedTypes = null)
        {
            this.entityTransform = entityTransform;
            this.hasBehavioralComponents = hasBehavioralComponents;
            if (excludedTypes != null)
        ...
        public bool TryGetComponent<Tcomponent>(out Tcomponent component)
        {
            ...
            {
                // Safe to cast since we only store Tcomponent instances under their respective types
                if (components[type] is Tcomponent typedComp)
                {
                    component = typedComp;
                    return true;
                }

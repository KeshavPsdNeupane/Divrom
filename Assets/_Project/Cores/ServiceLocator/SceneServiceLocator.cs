...
namespace ServiceLocatorPattern
{
    ...
    /// Here _A_RS means "Added via RegisterService" and _S_FOD means "Found on Demand on Scene".
    ...
    public class SceneServiceLocator : ServiceLocator<SceneServiceLocator, SceneServiceBase>
    {
        ...
        public bool TryGetService<TService>(out TService service) where TService : SceneServiceBase
        {
            ...
            if (instances.Length > 0)
            {
                ...
                RenameAndRegister(mainInstance, " [Scene]_S_FOD", "Found on Demand, Please Add the " + type.Name +
